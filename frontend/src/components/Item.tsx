...
const Item = ({ item, onDeleteClicked,onStartClicked }: ItemProps) => {
  ...
  return (
    ...
    >
      ...
      <Button onClick={()=>{onStartClicked(item)}} size="sm" disabled={item.state.id === 4 || item.state.id === 5 ? false : true}>Start</Button>
      ...
      <div className="flex">
        ...
        {(item.state.id === 4 || item.state.id === 5) && (
          <span className="ml-3 text-center align-items text-sm ">
